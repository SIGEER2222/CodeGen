...
public static class AttributeGenerator {
    ...
    public static SyntaxList<AttributeListSyntax> Create(params TesturaAttribute[] attributes) {
    ...
    private static AttributeSyntax Create(TesturaAttribute attribute) {
