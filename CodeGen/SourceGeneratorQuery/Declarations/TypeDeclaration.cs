...
public class TypeDeclaration {
  ...
  public string Namespace => SourceFile.Namespaces.FirstOrDefault();

  public bool IsPartial =>
    SyntaxNode.Modifiers.Any(x => x.Text == "partial");
  ...
  public string Name => SyntaxNode.Identifier.Text;
  ...
  public IEnumerable<TypeDeclaration> GetPartialClasses() {
    return SyntaxNode.ChildNodes().OfType<ClassDeclarationSyntax>()
  ...
  public IEnumerable<PropertyDeclarationSyntax> GetPropertiesWithoutAttributesOrDefaults() {
    return SyntaxNode.ChildNodes().OfType<PropertyDeclarationSyntax>()
