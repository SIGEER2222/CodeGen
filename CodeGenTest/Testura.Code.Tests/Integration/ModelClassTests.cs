...
public class ModelClassTests {
  ...
  public void Test_CreateClassWithEnum() {
    var @class = new ClassBuilder("Cat", "Models")
        .WithUsings("System")
        .With(new EnumBuildMember("MyEnum", new List<EnumMember> { new("EnumValueOne", 2, new TesturaAttribute[] { new TesturaAttribute("MyAttribute"), }), new EnumMember("EnumValueTwo") }, new List<Modifiers> { Modifiers.Public }))
        .Build();
